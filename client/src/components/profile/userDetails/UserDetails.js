    ...
    <div>
        <div className='flex mb-10'>
            ...
            <section className='flex-[2]'>
                <div className='flex justify-center items-start gap-y-2 flex-col flex-wrap h-full my-auto mx-0'>
                <div className='flex items-center'>
                    <div className='text-2xl font-semibold mr-5'>username</div>
                ...
                <div className='flex items-center space-x-8'>
                    <div className='font-semibold'><span className='font-bold'>3</span> posts</div>
                    <div className='font-semibold'><span className='font-bold'>3</span> followers</div>
                    <div className='font-semibold'><span className='font-bold'>3</span> following</div>
                </div>
                <div>
                    <div>
                    Full Name
                    </div>
                <div className='font-thin'>Bio</div>
                </div>
                </div>
            </section>
        </div>
